    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="#"><span class="glyphicon glyphicon-earphone"
                                                          aria-hidden="true"></span> 产权人服务</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/admin/selectallcomplaint.do"><span
                            class="glyphicon glyphicon-warning-sign" aria-hidden="true"> </span> 投诉</a>

                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/admin/selectallsuggest.do"><span
                            class="glyphicon glyphicon-comment" aria-hidden="true"></span> 建议</a>

                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/admin/selectallrepaid.do"><span
                            class="glyphicon glyphicon-wrench" aria-hidden="true"> </span> 维修</a>
                </li>
            </ul>
        </div>
        ...
        <div id="page-inner">
            <div class="container">
                ...
                <div class="row col-md-offset-7">
                    <div class="col-md-7">
                        <form role="form" id="selecttype" action="${pageContext.request.contextPath}/admin/docsrselect.do" style="margin-bottom: 20px;">
                    ...
                    <div class="col-md-5">
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/admin/selectcsr.do?pn=${csr.pages}">末页</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
