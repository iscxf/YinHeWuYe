            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/selectallcomplaint.do"><span class="glyphicon glyphicon-warning-sign" aria-hidden="true"> </span> 投诉</a>

                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/selectallsuggest.do"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>  建议</a>

                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/admin/selectallrepaid.do"><span class="glyphicon glyphicon-wrench" aria-hidden="true"> </span> 维修</a>
                        </li>
                    </ul>
                </div>
                                 ...
                                 <div class="input-group" >
                                     <div class="input-group-btn">
                                         <select class="form-control" name="selecttype" style="width: auto">
                                             <option value="A"><button>全部记录</button></option>
                                             <option value="A1"><button>提交人id</button></option>
                                         </select>
                                     </div>
