				...
				<div class="row">
					...
					<div class="col-sm-3 col-md-3 col-lg-3" id="pill-nav">
				        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						   ...
						   <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="jianyi.jsp" role="tab" aria-controls="v-pills-messages" aria-selected="false">
						   		<i class="fa fa-envelope-o" style="font-size:24px"></i>
						   		<h5>建议</h5>
						   </a>
						   <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="baoxiu.jsp" role="tab" aria-controls="v-pills-messages" aria-selected="false"  style="background-color: #E6E6E6;">
				    ...
				    <div class="col-sm-9 col-md-9 col-lg-9" id="form-tousu">
				    	...
				    	<fieldset id="">
				    		<legend>住户报修表</legend>
							<form action="${pageContext.request.contextPath}/index/addcsr.do" id="repiadform" method="post">
								<input hidden name="csrType" value="3" id="abc"/>
								<input hidden name="user_id" value="${sessionScope.user.userid}" id="ac"/>
						    	<div class="form-group">
								    <label for="exampleFormControlTextarea1">请输入报修内容</label>
