...
<div class="container-fulid navTmp">
    ...
    <nav class="navbar navbar-expand-md fixed-top text-light head_nav">
        ...
        <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#top_nav"
                aria-controls="top_nav" aria-expanded="false" aria-label="Toggle navigation text-light"
                style="color: #FFFFFF">
        ...
        <div class="col-nd-4 col-lg-4" style="margin-right: -80px;">
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="javascript:void(0);" onclick="logout();" target="_parent" class="nav-link"
                           title="退出系统">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-md-3 col-lg-3" id="pill-nav">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="index.jsp" role="tab"
                       aria-controls="v-pills-home" aria-selected="true" title="回到首页" style="height: 4em;">
                    ...
                    <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="tousu.jsp" role="tab"
                       aria-controls="v-pills-messages" aria-selected="false" style="background-color: #E6E6E6;">
                        <i class="fa fa-exclamation-triangle" style="font-size:24px"></i>
                        <h5>投诉</h5>
                    </a>
                    <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="jianyi.jsp" role="tab"
                       aria-controls="v-pills-messages" aria-selected="false">
                        <i class="fa fa-envelope-o" style="font-size:24px"></i>
                        <h5>建议</h5>
                    </a>
                    <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="baoxiu.jsp" role="tab"
                       aria-controls="v-pills-messages" aria-selected="false">
            ...
            <div class="col-sm-9 col-md-9 col-lg-9" id="form-tousu">
                ...
                <fieldset id="">
                    <legend>住户投诉表</legend>
                    <form action="${pageContext.request.contextPath}/index/addcsr.do" id="compliantform" method="post">
                        <input hidden name="csrType" value="1"/>
                        <input hidden name="user_id" value="${sessionScope.user.userid}"/>
                        <div class="form-group">
                            <label for="mytest">请输入投诉内容</label>
                            <textarea class="form-control" name="csrText" id="mytest" rows="5"
                                      placeholder="请输入..."></textarea>
                            <small class="form-text text-muted">
                                请说明您要投诉的对象（人/事物）以及原因
                            </small>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-7">
                                <label for="inputName">请输入您的名字</label>
                                <input type="text" name="csrName" id="inputName" class="form-control"
                                       placeholder="请输入...">
                                <small class="form-text text-muted">
                                    名字不能为空
                                </small>
                            ...
                            <div class="form-group col-md-7">
                                ...
                                <input type="text" name="csrPhone" id="inputTel" class="form-control"
                                       placeholder="家庭固话/手机号码">
                                <small class="form-text text-muted">
                                    联系方式可以为空
                                </small>
                            </div>
