				...
				<div class="collapse navbar-collapse">
					<ul class="navbar-nav">
						<li class="nav-item" style="margin-top: 6px;">
							<a href="" class="nav-link" style="font-size:16px;font-weight: bold;">
				...
				<div class="row">
					...
					<div class="col-sm-3 col-md-3 col-lg-3" id="pill-nav">
				        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						   ...
						   <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="${pageContext.request.contextPath}/index/queryUserInfo.do" role="tab" aria-controls="v-pills-messages" aria-selected="false" style="background-color: #E6E6E6;">
						   ...
						   <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="${pageContext.request.contextPath}/index/queryUserCharge.do" role="tab" aria-controls="v-pills-messages" aria-selected="false">
				    			...
				    			<tbody>
				    				<tr>
				    					<td>
				    						...
				    						<a href="#">个人信息查询</a>
				    						<span>>></span>
				    						<a href="${pageContext.request.contextPath}/index/queryUserInfo.do">房产信息</a>
				    					</td>
				    				</tr>
				    			</tbody>
				    	</table>
	                                ...
	                                <div class="table-responsive">
		                                <table class="table table-hover">
		                                    <tr style="border-bottom: 2px solid #DDDDDD;">
		                                        <th>房产号</th>
		                                        <td id="hpid">${sessionScope.housProp.hpid}</td>
		                                        <th>楼号</th>
		                                        <td id="buil_id">${sessionScope.housProp.buil_id}</td>
		                                    </tr> 
		                                    <tr style="border-bottom: 2px solid #DDDDDD;">
		                                        <th>单元号</th>
		                                        <td id="unit">${sessionScope.housProp.unit}</td>
		                                        <th>门牌号</th>
		                                        <td id="doorplate">${sessionScope.housProp.doorplate}</td>
		                                    </tr> 
		                                    <tr style="border-bottom:2px solid #DDDDDD;">
		                                        <th>住户编号</th>
		                                        <td id="resiid">${sessionScope.housProp.resident.resid}</td>
		                                        <th>住户名字</th>
		                                        <td id="resiName">${sessionScope.housProp.resident.resiName}</td>
		                                    </tr> 
		                                    <tr style="border-bottom:2px solid #DDDDDD;">
		                                        <th>户主身份证</th>
		                                        <td id="resilden">${sessionScope.housProp.resident.resiIden}</td>
		                                        <th>家庭常住人口(/人)</th>
		                                        <td id="resiTota">${sessionScope.housProp.resident.resiTota}</td>
		                                    </tr>  
		                                </table>
	                                </div>		
	                            </div>
