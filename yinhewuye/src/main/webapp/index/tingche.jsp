					...
					<div class="col-sm-3 col-md-3 col-lg-3" id="pill-nav">
				        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						   ...
						   <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="${pageContext.request.contextPath}/index/queryUserInfo.do" role="tab" aria-controls="v-pills-messages" aria-selected="false">
						   		...
						   		<h5 style="margin-left: 0.4em;">房产信息</h5>
						   </a>
						   <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="${pageContext.request.contextPath}/index/selectspotmanabyuser.do" role="tab" aria-controls="v-pills-messages" aria-selected="false" style="background-color: #E6E6E6;">
				    			...
				    			<tbody>
				    				<tr>
				    					<td>
				    						...
				    						<a href="#">个人信息查询</a>
				    						<span>>></span>
				    						<a href="${pageContext.request.contextPath}/index/selectspotmanabyuser.do">停车信息</a>
				    					</td>
				    				</tr>
				    			</tbody>
				    	</table>
	                                ...
	                                <div class="table-responsive">
		                                <table class="table table-hover">
											...
											<c:forEach items="${spotmana.list}" var="spotmana">
												...
												<tr class="mylist" style="border-bottom: 2px solid #DDDDDD;">
